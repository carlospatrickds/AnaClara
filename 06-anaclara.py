...
def gerar_pdf_auditoria_completa(df_resultado, uploaded_filename, total_salario_familia, total_inss, total_irrf, folha_liquida_total, observacoes=""):
...
with tab1:
    ...
    if st.button("Calcular", type="primary"):
        ...
        dados_pdf = {
            ...
            "observacoes": observacoes_individual  # Inclui as observações no PDF
        }
                ...
                with st.spinner("Gerando relatório PDF..."):
                    try:
                        pdf = gerar_pdf_auditoria_completa(
                            ...
                            total_irrf,
                            folha_liquida_total,
                            observacoes_lote  # Passa as observações para o PDF
                        )
                        # SAÍDA LIMPA: retorna objeto bytes
                        pdf_output = pdf.output(dest='S')
